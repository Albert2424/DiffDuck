...
def generate_input(structure_dir, smiles, run_name):
    ...
    for f in folders:
        ...
        try:
            os.mkdir(f'prot_structures/{run_name}/merged_structures')
        except:
            pass
        ...
        for pair in pair_ind:
            ...
            new_pdb(f'prot_structures/{run_name}/merged_structures/{f}/{id}.pdb', f'{structure_dir}/{f}/{prot_a}', f'{structure_dir}/{f}/{prot_b}')

            ids.append(id)
            s.append(smiles)
            p.append(os.path.abspath(f'prot_structures/{run_name}/merged_structures/{f}/{id}.pdb'))
...
if __name__ == '__main__':
    ...
    generate_input(f'prot_structures/{args.run_name}',args.SMILES,args.run_name)